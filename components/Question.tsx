...
return (
  ...
  <p className="mt-5 mb-5  font-inter font-semibold">Site by Luca Machiedo (Mitglied der <a href="https://twrdroste.de" className=" font-playfair text-orange-600 font-bold">TWR</a>)</p>

...
export default function Home() {
  ...
  return (
    ...
    <p className="mt-5 mb-5 md:mb-0 font-inter font-semibold">Site by Luca Machiedo (<a href="https://twrdroste.de" className=" font-playfair text-orange-600 font-bold">TWR</a>)</p>
